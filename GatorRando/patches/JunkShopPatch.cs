    ...
    private static IEnumerable<CodeInstruction> TranspileRunShopDialogueSequence(IEnumerable<CodeInstruction> instructions)
    {
        ...
        foreach (CodeInstruction instruction in instructions)
        {
            ...
            CodeInstruction newInstruction = counter switch
            {
                ...
                234 => CodeInstruction.Call(typeof(UnityEngine.Object), "get_name"),
                235 => CodeInstruction.Call(typeof(LocationHandling), nameof(LocationHandling.CollectLocationByName), [typeof(string)]),
                236 => new(OpCodes.Pop),
                237 => CodeInstruction.Call(typeof(QuestMods.Junk4TrashQuestMods), nameof(QuestMods.Junk4TrashQuestMods.HideCollectedShopLocations)),
                238 => nop,
                239 => nop,
                240 => nop,
                // 241 and 242 intentionally untouched (UpdateInventory)
