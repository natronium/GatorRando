...
//             {
//                 postConnectAction();
//                  //send all locations that in the local save but are not in the server's record (in case of disconnection)
//                  //receive all new items from the AP server
//                  //trigger listener functions for *any* item we have, not just recently received ones
//                  //trigger listener functions for any location that is collected
//                  //hook up listener functions for future live updates
