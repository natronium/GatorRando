...
public static class Items
{
    ...
    public readonly static List<Item> itemData = [
        ...
        new Item("Sleep Mask", 100000066, "SleepMask", null, ClientItemType.Item, [ItemGroup.Unlock]),
        new Item("Giant Socks", 100000067, "Socks", null, ClientItemType.Item, [ItemGroup.Unlock]),
        new Item("Tiger Form", 100000068, "Tiger", null, ClientItemType.Item, [ItemGroup.Unlock]),
